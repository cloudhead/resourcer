    ...
    this.addListener('init', function (R) {
        ...
        if (R.connection.protocol === 'database') {
            if (typeof(filter) === 'object') {
                ...
                }, { object: filter, resource: JSON.stringify(R.resourceName) });
                ...
                R.views[name] = render({
                    ...
                    resource: JSON.stringify(R.resourceName) });
                require('sys').puts(R.views[name].map)
            ...
            R[name] = function () {
                ...
                this.reload(function () {
                    that.view([that.resourceName, name].join('/'), params)
                        .addCallbacks(callback, promise);
                });
                return promise;
            };
        }
