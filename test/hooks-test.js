...
vows.describe('resourcer/events').addBatch({
    "a Resource": {
        topic: function () {
            return resourcer.define('resource', function () {
                this.property('title');
            });
        },
        "with 'before' hooks on `save`": {
            topic: function (A) {
                A.before('save', function (obj, next) {
                    obj.counter += 1; next(null);
                });
                A.before('save', function (obj, next) {
                    obj.counter *= 2; next(null);
                });
                return A;
            },
            "when calling save() on an instance of Article": {
                topic: function (A) {
                    new(A)({ _id: '64', counter: 0 }).save(this.callback);
                },
    ...
    "another Resource": {
        topic: function () {
            return resourcer.define('resource2', function () {
                this.property('title');
            });
        },
        "with 'after' hooks on `save`": {
            ...
            "when calling save() on an instance of Article": {
                topic: function (A) {
                    new(A)({ _id: '65', counter: 0 }).save(this.callback);
                },
                "should trigger both hooks in the right order": function (e, res) {
